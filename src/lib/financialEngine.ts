...
export const defaultFinancialModuleState: FinancialModuleState = {
  ...
  insuranceProtection: [],
  behaviour: {
    maintainMonthlyBudget: "" as any,
    trackExpensesRegularly: "" as any,
    investFrequency: "" as any,
    reviewInvestmentsFrequency: "" as any,
    fileTaxesOnTime: "" as any,
    hasEmergencyFundSetAside: "" as any,
    missedEmiPayments: "" as any,
    missedCreditCardPayments: "" as any,
    hasClearFinancialGoals: "" as any,
  },
  goals: [],
  riskProfile: {
