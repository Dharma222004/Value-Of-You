...
export const CareerDetail: React.FC = () => {
  ...
  return (
    <section id="career-detail" className="py-28 sm:py-36 relative bg-[#04060e] text-white overflow-hidden">
      
      {/* Background Radial Glow */}
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 w-[800px] h-[500px] bg-radial from-[#3b82f6]/10 via-[#06b6d4]/04 to-transparent blur-[140px] pointer-events-none rounded-full" />
      ...
      <div className="grid-container relative z-10 space-y-12">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#3b82f6]/10 border border-[#3b82f6]/25 text-[#60a5fa] text-xs font-mono font-bold uppercase tracking-wider shadow-[0_0_15px_rgba(59,130,246,0.15)]">
          ...
          <p className="body-text mx-auto text-[#94a3b8] text-base sm:text-lg">
        ...
        <div className="grid lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="lg:col-span-6 bg-[#090d1a] rounded-2xl p-7 border border-white/[0.08] flex flex-col justify-between space-y-6">
            <div className="flex items-center justify-between font-mono text-xs">
              <span className="text-[#94a3b8] font-bold uppercase tracking-wider flex items-center gap-2">
                <Target className="w-4 h-4 text-[#3b82f6]" />
                5-DIMENSION RADAR CHART
              </span>
              <span className="text-[#06b6d4] font-semibold bg-[#06b6d4]/10 px-2.5 py-1 rounded border border-[#06b6d4]/20">
                Balanced Growth
              </span>
            </div>
          ...
          <div className="lg:col-span-6 space-y-6 flex flex-col justify-between">
            ...
            <div className="bg-[#090d1a] rounded-2xl p-6 sm:p-7 border border-white/[0.08] space-y-6">
              <div className="flex items-center justify-between font-mono text-xs">
                <span className="text-[#94a3b8] font-bold uppercase tracking-wider flex items-center gap-2">
              ...
              <div className="pt-2 pb-4">
                <div className="relative flex items-center justify-between">
                  ...
                  <div className="absolute top-4 left-4 right-4 h-0.5 bg-white/[0.1] -z-0" />
                    ...
                    return (
                      <div key={i} className="relative z-10 flex flex-col items-center text-center group">
                        ...
                        <div className={`w-8 h-8 rounded-full flex items-center justify-center transition-all ${
                          isCurrent
                            ? "bg-[#10b981] text-black font-bold ring-4 ring-[#10b981]/25 shadow-[0_0_15px_rgba(16,185,129,0.5)]"
                            : isPast
                            ? "bg-[#3b82f6] text-white"
                            : "bg-[#090d1a] border-2 border-white/[0.2] text-[#64748b]"
                        }`}>
                          <span className="text-[10px] font-mono font-bold">{node.year.slice(2)}</span>
                        </div>

                        {/* Stage Name */}
                        <span className={`text-[11px] font-mono mt-2 block ${isCurrent ? "text-white font-bold" : "text-[#94a3b8]"}`}>
                          {node.stage}
                        </span>

                        {/* YOU ARE HERE Badge on 2026 */}
                        {isCurrent && (
                          <span className="mt-1 font-mono text-[9px] font-extrabold text-[#10b981] bg-[#10b981]/15 px-2 py-0.5 rounded-full border border-[#10b981]/30 shadow-[0_0_10px_rgba(16,185,129,0.2)] animate-pulse uppercase tracking-wider">
                            YOU ARE HERE
                          </span>
                        )}
                      </div>
            ...
            <div className="bg-[#090d1a] rounded-2xl p-6 sm:p-7 border border-white/[0.08] space-y-4">
              <div className="flex items-center justify-between font-mono text-xs">
                <span className="text-[#94a3b8] font-bold uppercase tracking-wider flex items-center gap-2">
                  <ShieldCheck className="w-4 h-4 text-[#06b6d4]" />
                  MILESTONE TRACKER
                </span>
                <span className="text-[#94a3b8]">4/5 Completed</span>
              </div>

              <div className="space-y-2.5">
                {milestones.map((m, idx) => (
                  <div key={idx} className="flex items-center justify-between p-3 rounded-xl bg-[#05070f] border border-white/[0.06] text-xs font-mono">
                    <span className="text-white font-semibold">{m.label}</span>
                    {m.status === "completed" ? (
                      <span className="flex items-center gap-1.5 text-[#10b981] font-bold bg-[#10b981]/10 px-2.5 py-0.5 rounded border border-[#10b981]/20">
                        <CheckCircle2 className="w-3.5 h-3.5" />
                        <span>✓ Completed</span>
                      </span>
                    ) : (
                      <span className="flex items-center gap-1.5 text-[#f59e0b] font-bold bg-[#f59e0b]/10 px-2.5 py-0.5 rounded border border-[#f59e0b]/20">
        ...
        <div className="bg-[#090d1a] rounded-2xl p-7 border border-white/[0.08] space-y-6">
          <div className="flex items-center justify-between font-mono text-xs">
            <span className="text-[#94a3b8] font-bold uppercase tracking-wider flex items-center gap-2">
              <BarChart3 className="w-4 h-4 text-[#3b82f6]" />
              DIMENSION HEATMAP & TARGET SCORES
            </span>
            <span className="text-[#64748b]">CURRENT vs TARGET BENCHMARK</span>
          </div>
                ...
                <div key={dim.name} className="space-y-1.5 font-mono text-xs">
                  <div className="flex items-center justify-between text-xs">
                    ...
                    <div className="flex items-center gap-3">
                      <span className="text-[#94a3b8]">Current: <strong className="text-white font-bold">{dim.current}</strong></span>
                      <span className="text-[#64748b]">Target: <strong className="text-[#10b981] font-bold">{dim.target}</strong></span>
                    </div>
                  </div>

                  <div className="h-3 w-full bg-[#050814] rounded-full overflow-hidden p-0.5 border border-white/[0.06] relative">
                    <motion.div
                      initial={{ width: 0 }}
                      whileInView={{ width: `${dim.current}%` }}
                      viewport={{ once: true }}
                      transition={{ duration: 0.8, ease: "easeOut" }}
                      className={`h-full bg-gradient-to-r ${dim.color} rounded-full shadow-[0_0_10px_rgba(59,130,246,0.3)]`}
                    />
        ...
        <div className="bg-[#090d1a] rounded-2xl p-7 border border-white/[0.08] space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 items-center">
            {/* Step 1: Input Layer */}
            <div className="p-4 rounded-xl bg-[#05070f] border border-white/[0.08] space-y-2 text-xs font-mono">
            ...
            <div className="p-4 rounded-xl bg-[#05070f] border border-[#3b82f6]/30 space-y-2 text-xs font-mono shadow-[0_0_12px_rgba(59,130,246,0.15)]">
            ...
            <div className="p-4 rounded-xl bg-[#05070f] border border-[#10b981]/30 space-y-2 text-xs font-mono text-center">
            ...
            <div className="p-4 rounded-xl bg-[#05070f] border border-[#8b5cf6]/30 space-y-2 text-xs font-mono">
        ...
        <div className="bg-[#090d1a] rounded-2xl p-7 border border-white/[0.08] space-y-6">
          <div className="flex flex-wrap items-center justify-between gap-4 font-mono text-xs">
            ...
            <div className="flex items-center gap-2 bg-[#05070f] p-1 rounded-xl border border-white/[0.08]">
              ...
              >
                {roadmapActions[activeTab].map((action, idx) => {
                  ...
                  return (
                    <div
                      key={action.id}
                      className="p-4 sm:p-5 rounded-2xl bg-[#05070f] border border-white/[0.08] hover:border-[#3b82f6]/40 hover:bg-[#080d1e] transition-all duration-200 group flex flex-col lg:flex-row lg:items-center justify-between gap-4 shadow-sm"
                    >
                      {/* Left: Index badge + Title + Subtitle */}
                      <div className="flex items-start gap-3.5 flex-1 min-w-0">
                        <div className="w-8 h-8 rounded-xl bg-[#3b82f6]/10 border border-[#3b82f6]/25 flex items-center justify-center text-[#60a5fa] font-mono font-bold text-xs shrink-0 mt-0.5 group-hover:scale-105 transition-transform shadow-inner">
                      ...
                      <div className="flex flex-wrap items-center gap-2 font-mono text-xs shrink-0 pt-2 lg:pt-0 border-t lg:border-t-0 border-white/[0.06]">
                        {/* Dimension Pill */}
                        <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-lg bg-[#3b82f6]/10 border border-[#3b82f6]/20 text-[#60a5fa] text-[11px] font-semibold">
                          <Target className="w-3 h-3 text-[#3b82f6]" />
                          <span>{action.dimension}</span>
                        </span>

                        {/* Time Pill */}
                        <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-white/[0.04] border border-white/[0.08] text-[#cbd5e1] text-[11px]">
                        ...
                        <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-lg bg-[#10b981]/15 border border-[#10b981]/30 text-[#10b981] text-[11px] font-extrabold shadow-[0_0_10px_rgba(16,185,129,0.15)]">
