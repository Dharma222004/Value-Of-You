...
import { DebugProgressPanel } from "@/components/dashboard/DebugProgressPanel";
...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <ModuleProgressProvider>
      <div className="min-h-screen bg-[var(--bg-base)] text-[var(--text-primary)] flex relative overflow-hidden bg-grid-pattern">
        {/* Desktop Sidebar */}
        ...
        {/* Real-time Debug Synchronization Panel */}
        <DebugProgressPanel />
      </div>
    </ModuleProgressProvider>
  );
