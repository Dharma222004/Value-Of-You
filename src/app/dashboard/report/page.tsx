          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
            ...
            <div className="w-full max-w-md mx-4 text-center space-y-6">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400 mt-1">4 AI Agents (NVIDIA Nemotron + Groq + Gemini + Oxlo) evaluating telemetry</p>
              </div>
          ...
          <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }}
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400">Re-runs NVIDIA Nemotron 550B, Groq & Gemini multi-agent pipeline.</p>
              </div>
            </div>
                ...
                <div className="flex-1 space-y-5 text-left">
                  <div>
                    ...
                    <p className="text-sm text-slate-200 leading-relaxed font-normal">
                      {cleanText(reportData?.executiveSummary) || `Comprehensive multi-agent evaluation identifies ${userName} as an ${getTierDetails(overallScore).label} candidate. Demonstrates exceptional cognitive adaptability, strategic vision, and structural execution capacity across multi-dimensional benchmarks.`}
                    </p>
                  </div>
            ...
            <footer className="glass-card p-6 sm:p-7 rounded-3xl border border-white/[0.08] flex flex-col lg:flex-row items-center justify-between gap-6 text-xs text-slate-400 no-print bg-slate-900/90 shadow-2xl">
              <div className="space-y-1.5 text-center lg:text-left min-w-0">
                <div className="flex items-center justify-center lg:justify-start gap-2 flex-wrap text-white font-semibold">
                  ...
                  <span className="text-indigo-300 font-mono text-[11px] font-medium">NVIDIA Nemotron 550B • Groq GPT-OSS 120B • Oxlo DeepSeek V3.2 • Gemini 3.6 Flash</span>
                </div>
