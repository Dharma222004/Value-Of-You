...
6. For EACH of the 10 scored dimensions, populate: what_it_measures (1 sentence), performance_summary (2-3 sentences, tone matches score level), suggestions (2-4 actionable strings), resources (2-3 objects with real title + type), subsections (3 objects with label + score 0-100).
7. Preserve the Human Values agent's humanValuesAnalysis.valueScores object when present. Do not invent value scores when the Human Values Test history is missing.
...
OUTPUT (valid JSON): {
  ...
  "scores": {
    "humanValues": {"score": 75, "explanation": "Cite specific assessment data...", "what_it_measures": "This dimension evaluates moral integrity, empathy, and alignment with core ethical principles.", "performance_summary": "2-3 sentences based on score and evidence.", "suggestions": ["Practice daily ethical reflection journaling.", "Engage in community service to strengthen empathy."], "resources": [{"title": "The Righteous Mind", "type": "Book"}, {"title": "Ethics in the Real World", "type": "Web"}], "subsections": [{"label": "Integrity", "score": 78}, {"label": "Empathy", "score": 74}, {"label": "Ethical Reasoning", "score": 73}]},
    "financialIntelligence": {"score": 60, "explanation": "Cite actual savings rate, income, emergency fund...", "what_it_measures": "This dimension measures capital allocation discipline, savings behavior, and long-term wealth-building capacity.", "performance_summary": "2-3 sentences based on score.", "suggestions": ["Automate 20% of income to savings on payday.", "Build a 3-month emergency fund before any discretionary spending."], "resources": [{"title": "The Psychology of Money", "type": "Book"}, {"title": "Personal Finance Club", "type": "Web"}], "subsections": [{"label": "Savings Discipline", "score": 55}, {"label": "Investment Behavior", "score": 62}, {"label": "Risk Management", "score": 63}]},
    "leadership": {"score": 72, "explanation": "Cite actual leadership assessment score...", "what_it_measures": "This dimension assesses the ability to inspire teams, set strategic direction, and drive organizational outcomes.", "performance_summary": "2-3 sentences based on score.", "suggestions": ["Lead a cross-functional project in the next 30 days.", "Read one leadership book per month."], "resources": [{"title": "Leaders Eat Last", "type": "Book"}, {"title": "HBR Leadership Articles", "type": "Web"}], "subsections": [{"label": "Strategic Vision", "score": 70}, {"label": "Team Influence", "score": 74}, {"label": "Decision Authority", "score": 72}]},
    "communication": {"score": 78, "explanation": "Cite communication assessment data...", "what_it_measures": "This dimension evaluates business articulation, persuasion effectiveness, and interpersonal adaptability.", "performance_summary": "2-3 sentences based on score.", "suggestions": ["Practice structured storytelling in every meeting.", "Record and review your own presentations weekly."], "resources": [{"title": "Crucial Conversations", "type": "Book"}, {"title": "TED Talks on Communication", "type": "Video"}], "subsections": [{"label": "Verbal Clarity", "score": 80}, {"label": "Written Communication", "score": 76}, {"label": "Active Listening", "score": 78}]},
    "selfAwareness": {"score": 74, "explanation": "Cite self-awareness assessment data...", "what_it_measures": "This dimension measures introspective depth, emotional regulation, and the ability to identify personal blind spots.", "performance_summary": "2-3 sentences based on score.", "suggestions": ["Keep a daily reflection journal for 21 days.", "Seek candid 360-degree feedback from 3 trusted peers."], "resources": [{"title": "Emotional Intelligence 2.0", "type": "Book"}, {"title": "Insight by Tasha Eurich", "type": "Book"}], "subsections": [{"label": "Introspection", "score": 76}, {"label": "Emotional Regulation", "score": 72}, {"label": "Blind Spot Awareness", "score": 74}]},
    "decisionMaking": {"score": 70, "explanation": "Cite decision making data...", "what_it_measures": "This dimension evaluates risk-weighted judgment quality, decision speed, and cognitive clarity under pressure.", "performance_summary": "2-3 sentences based on score.", "suggestions": ["Apply the 10-10-10 framework before major decisions.", "Create a personal decision journal to review past choices."], "resources": [{"title": "Thinking, Fast and Slow", "type": "Book"}, {"title": "Decision Making Course", "type": "Tutorial"}], "subsections": [{"label": "Analytical Rigor", "score": 72}, {"label": "Risk Assessment", "score": 68}, {"label": "Decision Speed", "score": 70}]},
    "growthMindset": {"score": 76, "explanation": "Cite growth mindset assessment...", "what_it_measures": "This dimension assesses adaptability, resilience to failure, and commitment to continuous self-improvement.", "performance_summary": "2-3 sentences based on score.", "suggestions": ["Deliberately attempt one new challenging skill per month.", "Reframe every failure as a data point in your growth log."], "resources": [{"title": "Mindset by Carol Dweck", "type": "Book"}, {"title": "Growth Mindset Course on Coursera", "type": "Tutorial"}], "subsections": [{"label": "Adaptability", "score": 78}, {"label": "Resilience", "score": 75}, {"label": "Learning Orientation", "score": 75}]},
    "consistency": {"score": 68, "explanation": "Cite health/workout/sleep consistency data...", "what_it_measures": "This dimension measures behavioral stability, commitment execution, and stress tolerance over sustained periods.", "performance_summary": "2-3 sentences based on score.", "suggestions": ["Set a non-negotiable sleep schedule 7 days a week.", "Track workout adherence with a habit-tracking app."], "resources": [{"title": "Atomic Habits", "type": "Book"}, {"title": "Huberman Lab Podcast", "type": "Video"}], "subsections": [{"label": "Sleep Discipline", "score": 65}, {"label": "Workout Adherence", "score": 70}, {"label": "Stress Resilience", "score": 69}]},
    "learningAbility": {"score": 73, "explanation": "Cite certifications, skills, learning data...", "what_it_measures": "This dimension evaluates the speed of skill acquisition, conceptual synthesis, and intellectual curiosity.", "performance_summary": "2-3 sentences based on score.", "suggestions": ["Complete one professional certification in the next 60 days.", "Dedicate 30 minutes daily to deliberate learning in your domain."], "resources": [{"title": "Learn Like a Pro", "type": "Book"}, {"title": "Coursera / edX", "type": "Tutorial"}], "subsections": [{"label": "Skill Acquisition Rate", "score": 74}, {"label": "AI Readiness", "score": 72}, {"label": "Technical Depth", "score": 73}]},
    "professionalReadiness": {"score": 71, "explanation": "Cite technical skills, experience, employability...", "what_it_measures": "This dimension measures employability index, domain expertise depth, and career progression velocity.", "performance_summary": "2-3 sentences based on score.", "suggestions": ["Add 2 portfolio projects that demonstrate real-world impact.", "Complete a market-recognized certification this quarter."], "resources": [{"title": "The Career Manifesto", "type": "Book"}, {"title": "LinkedIn Learning", "type": "Tutorial"}], "subsections": [{"label": "Domain Expertise", "score": 72}, {"label": "Certifications", "score": 68}, {"label": "Market Readiness", "score": 73}]},
